...
ARVANCLOUD_STORAGE_BUCKET = get_env("ARVANCLOUD_STORAGE_BUCKET")

ARVANCLOUD_STORAGE_ENDPOINT_URL = get_env("ARVANCLOUD_STORAGE_ENDPOINT_URL")
ARVANCLOUD_STORAGE_AWS_ACCESS_KEY_ID = get_env("ARVANCLOUD_STORAGE_AWS_ACCESS_KEY_ID")
ARVANCLOUD_STORAGE_AWS_SECRET_ACCESS_KEY = get_env(
    "ARVANCLOUD_STORAGE_AWS_SECRET_ACCESS_KEY"
)
